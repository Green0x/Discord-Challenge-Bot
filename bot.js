...
client.on("interactionCreate", async message => {
    if (!message.isChatInputCommand()) return;  // No more needing try catch for bad inputs!
    ...
    if(message.commandName === "challenge"){
        ...
        if(message.options.getSubcommand() === "wotlk"){
            ...
            if(challengeType === "extreme"){
                let basicLock5 = client.getClassicExtremeDatabase.get();
                let file = message.options.getAttachment("image")
                ...
                if(basicLock5.ClassicextremeLock === 1){
                ...
                if(basicLock5.ClassicExtremeLock === 0){
    ...
    if(message.commandName === "solve"){
        ...
        if(message.options.getSubcommand() === "basic"){
            ...
            if(basicSolve.beginnerLock === 1 && basicSolve.isVerifyBeginner === 0 && message.user.id !== basicSolve.setBeginnerId){
                ...
                await message.channel.send(`A challenger has solved this challenge <@${basicSolve.setBeginnerId}> or an Admin will need to verify it is correct by typing /accept basic or /decline basic if it's not correct`);
        ...
        if(message.options.getSubcommand() === "advanced"){
            ...
            if(basicSolve.advanceLock === 1 && basicSolve.isVerifyAdvance === 0 && message.user.id !== basicSolve.setAdvanceId){
                ...
                await message.reply({ embeds: [challengeSolveEmbed] });
                await message.channel.send(`A challenger has solved this challenge <@${basicSolve.setAdvanceId}> or an Admin will need to verify it is correct by typing /accept advanced or /decline advanced if it's not correct`);
        ...
        if(message.options.getSubcommand() === "extreme"){
            ...
            if(basicSolve.extremeLock === 1 && basicSolve.isVerifyExtreme === 0 && message.user.id !== basicSolve.setExtremeId){
                ...
                await message.reply({ embeds: [challengeSolveEmbed] });
                await message.channel.send(`A challenger has solved this challenge <@${basicSolve.setExtremeId}> or an Admin will need to verify it is correct by typing /accept extreme or /decline extreme if it's not correct`);
        ...
        if(message.options.getSubcommand() === "wotlk"){
            ...
            if(challengeType === "basic"){
                ...
                if(basicSolve.ClassicBasicLock === 1 && basicSolve.isVerifyClassicBasic === 0 && message.user.id !== basicSolve.setClassicBasicId){
                    ...
                    await message.reply({ embeds: [challengeSolveEmbed] });
                    await message.channel.send(`A challenger has solved this challenge <@${basicSolve.setClassicBasicId}> or an Admin will need to verify it is correct by typing /accept wotlk basic or /decline wotlk basic if it's not correct`);
            ...
            if(challengeType === "advanced"){
                ...
                if(basicSolve.ClassicLock === 1 && basicSolve.isVerifyClassic === 0 && message.user.id !== basicSolve.setClassicId){
                    ...
                    await message.reply({ embeds: [challengeSolveEmbed] });
                    await message.channel.send(`A challenger has solved this challenge <@${basicSolve.setClassicId}> or an Admin will need to verify it is correct by typing /accept wotlk advanced or /decline wotlk advanced if it's not correct`);
            ...
            if(challengeType === "extreme"){
                ...
                if(basicSolve.ClassicExtremeLock === 1 && basicSolve.isVerifyClassicExtreme === 0 && message.user.id !== basicSolve.setClassicExtremeId){
                    ...
                    await message.reply({ embeds: [challengeSolveEmbed] });
                    await message.channel.send(`A challenger has solved this challenge <@${basicSolve.setClassicExtremeId}> or an Admin will need to verify it is correct by typing /accept wotlk extreme or /decline wotlk extreme if it's not correct`);
    ...
    if(message.commandName === "accept"){
        ...
        if(message.options.getSubcommand() === "basic"){
            ...
            if(basicAccept.isVerifyBeginner === 1 && basicAccept.setBeginnerId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                ...
                message.reply(`Congratulations <@${basicAccept.beginnerChallengerId}> your challenge solve has been accepted and you have earned 3 points! Your current point total is: ${userscore2.points}`)
    
            } else{
                message.reply("You cannot accept this challenge");
            }            
        }
        ...
        if(message.options.getSubcommand() === "advanced"){
            ...
            if(basicAccept.isVerifyAdvance === 1 && basicAccept.setAdvanceId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                ...
                client.setScore.run(userscore2);
                message.reply(`Congratulations <@${basicAccept.advancedChallengerId}> your challenge solve has been accepted and you have earned 5 points! Your current point total is: ${userscore2.points}`)
        ...
        if(message.options.getSubcommand() === "extreme"){
            ...
            if(basicAccept.isVerifyExtreme === 1 && basicAccept.setExtremeId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                ...
                client.setScore.run(userscore2);
                message.reply(`Congratulations <@${basicAccept.extremeChallengerId}> your challenge solve has been accepted and you have earned 5 points! Your current point total is: ${userscore2.points}`)
        ...
        if(message.options.getSubcommand() === "wotlk"){
            ...
            if(challengeType === "basic"){
                ...
                if(basicAccept.isVerifyClassicBasic === 1 && basicAccept.setClassicBasicId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                    ...
                    client.setScore.run(userscore2);
                    message.reply(`Congratulations <@${basicAccept.classicBasicChallengerId}> your challenge solve has been accepted and you have earned 3 points! Your current point total is: ${userscore2.points}`)
            ...
            if(challengeType === "advanced"){
                ...
                if(basicAccept.isVerifyClassic === 1 && basicAccept.setClassicId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                    ...
                    client.setScore.run(userscore2);
                    message.reply(`Congratulations <@${basicAccept.classicChallengerId}> your challenge solve has been accepted and you have earned 5 points! Your current point total is: ${userscore2.points}`)
            ...
            if(challengeType === "extreme"){
                ...
                if(basicAccept.isVerifyClassicExtreme === 1 && basicAccept.setClassicExtremeId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                    ...
                    client.setScore.run(userscore2);
                    message.reply(`Congratulations <@${basicAccept.classicExtremeChallengerId}> your challenge solve has been accepted and you have earned 5 points! Your current point total is: ${userscore2.points}`)
...
//################################### CHALLENGE DECLINE ###########################################################
    if(message.commandName === "decline"){

        // BASIC DECLINE
        if(message.options.getSubcommand() === "basic"){
            let basicAccept = client.getRetailBasicDatabase.get();
            if(basicAccept.isVerifyBeginner === 1 && basicAccept.setBeginnerId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                message.reply(`Bad news <@${basicAccept.beginnerChallengerId}> your challenge solve has been declined. Please try again.`);
                client.isVerifyBeginnerOff.run();
            }             
        }
        ...
        if(message.options.getSubcommand() === "advanced"){
            let basicAccept = client.getRetailAdvancedDatabase.get();
            if(basicAccept.isVerifyAdvance === 1 && basicAccept.setAdvanceId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                message.reply(`Bad news <@${basicAccept.advancedChallengerId}> your challenge solve has been declined. Please try again.`);
                client.isVerifyAdvanceOff.run();
            }                    
        }
        ...
        if(message.options.getSubcommand() === "wotlk"){
            ...
            if(challengeType === "basic"){
                let basicAccept = client.getClassicBasicDatabase.get();
                if(basicAccept.isVerifyClassicBasic === 1 && basicAccept.setClassicBasicId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                    message.reply(`Bad news <@${basicAccept.classicBasicChallengerId}> your challenge solve has been declined. Please try again.`);
                    client.isVerifyClassicBasicOff.run();
                }
            }                                 
            ...
            if(challengeType === "advanced"){
                let basicAccept = client.getClassicAdvancedDatabase.get();
                if(basicAccept.isVerifyClassic === 1 && basicAccept.setClassicId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                    message.reply(`Bad news <@${basicAccept.classicChallengerId}> your challenge solve has been declined. Please try again.`);
                    client.isVerifyClassicOff.run();
                }
            }         
            ...
            if(challengeType === "extreme"){
                let basicAccept = client.getClassicExtremeDatabase.get();
                if(basicAccept.isVerifyClassicExtreme === 1 && basicAccept.setClassicExtremeId === message.user.id || message.member.roles.cache.some(r=>["Admin", "Bot", "Community Mod"].includes(r.name))){
                    message.reply(`Bad news <@${basicAccept.classicExtremeChallengerId}> your challenge solve has been declined. Please try again.`);
                    client.isVerifyClassicExtremeOff.run();
                }
            }         
        }
